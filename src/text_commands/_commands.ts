...
export type textCommandExecType = ((_message: any, _regexResults: RegExpExecArray, _extraRegex: (RegExpExecArray|null)[]) => Promise<TextCommandResult>) |
((message: any, regexResults: RegExpExecArray, extraRegex: (RegExpExecArray|null)[]) => TextCommandResult)
...
// So that TS can actually typecheck the various functions

import * as calculate from "./calculate"
import * as ignoreAuthor from "./ignoreAuthor"
import * as ignoreChannel from "./ignoreChannel"
import * as IMDance from "./IMDance"
import * as IMHello from "./IMHello"
import * as IMShower from "./IMShower"
import * as infoCommand from "./infoCommand"
import * as listAnyEnum from "./listAnyEnum"
import * as listCommands from "./listCommands"
import * as printAuthor from "./printAuthor"
import * as renderBarrel from "./renderBarrel"
import * as renderMonkeys from "./renderMonkeys"
import * as renderSnap from "./renderSnap"
import * as renderWelcome from "./renderWelcome"
import * as respondHowAreYou from "./respondHowAreYou"
import * as respondHowIs from "./respondHowIs"
import * as respondIm from "./respondIm"
import * as respondWhatIs from "./respondWhatIs"
import * as respondWhoIs from "./respondWhoIs"
import * as respondYoure from "./respondYoure"
import * as searchFandom from "./searchFandom"
import * as searchUncyclopediaRandom from "./searchUncyclopediaRandom"
import * as setAnyAny from "./setAnyAny"
import * as setAuthorAnyEnum from "./setAuthorAnyEnum"
...
const commands = [
    ...
    new TextCommand({name: "setAuthorAnyEnum", help: "'Set my reaction type to 4.' or 'Set my error type to 2.'", description: "Set the option for reactions, valid commands or errors.",
        ...
        execute: setAuthorAnyEnum.execute
    }),
    ...
    new TextCommand({name: "setAuthorReactChance", help: "Set my reaction chance to 50%.", description: "The chance that I will react to you.",
        ...
        execute: setAuthorReactChance.execute
    }),
    ...
    new TextCommand({name: "setAuthorReactEmote", help: "Set my reaction emote to 944199066911395840!", description: "Set what emote I will react to your messages with when you mention me.",
        ...
        execute: setAuthorReactEmote.execute
    }),
    ...
    new TextCommand({name: "exceptionTest", help: "Test your exception handling!", description: "I will cause an exception while executing a command.",
        ...
        execute: (message: any, regexRes: RegExpExecArray) => {throw new Error("Exception handling test!")}
    }),
    ...
    new TextCommand({name: "updateCurrencies", help: "Update currency conversion rates.", description: "I will update my currency conversion rates if enough time has passed.",
        ...
        execute: updateCurrencies.execute
    }),
    ...
    new TextCommand({name: "searchUncyclopediaRandom", help: "Random uncyclopedia page!", description: "I will link you a random uncyclopedia article.",
        ...
        execute: searchUncyclopediaRandom.execute
    })
]
